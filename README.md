...
<img width="1679" height="964" alt="Screenshot" src="https://github.com/user-attachments/assets/974fc6aa-7540-46c4-97f9-b9f2c4b2ac38" />


Key Features:
• Admin Analytics Dashboard – View total cars, rentals, and key business insights.

• Advanced Car Filtering – Filter cars by category, brand, model, fuel type.

• Rental History Tracking – Users can view past and upcoming bookings in a clean dashboard.

• Protected API Routes – Only authenticated users and admins can perform sensitive operations.

• Real-Time Availability Check – Prevents double-booking by dynamically verifying availability.

• Profile Management – Users can update personal details and manage accounts easily.

• Fully Responsive UI – Works smoothly across mobile, tablet, and desktop screens.

• Optimized API Endpoints – Clean and modular Express controller–route architecture.
...
• File Handling: Multer & ImageKit integration
