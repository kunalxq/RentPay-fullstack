        ...
        className='lg:col-span-2'>
          ...
          className='space-y-6'>
            ...
            <div>
              ...
              <p className='text-gray-500 bg-light p-4 rounded-lg'>{car.description}</p>
            </div>
            {/* Feature */}
            <div>
              <h1 className='text-xl font-medium mb-3'>Feature</h1>
              <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2 bg-light p-4 rounded-lg'>
                {
