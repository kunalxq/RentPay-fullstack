...
const CarCard = ({ car }) => {
  ...
  return (
    <Link to={`/cars/car-details/${car._id}`}>
      <div className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
        ...
        <div className='relative h-48 overflow-hidden'>
          ...
          {car.isAvaliable && <p className='absolute top-4 left-4 bg-primary/90 text-white text-xs px-2.5 py-1 rounded-full' >Avaliable Now</p>}
