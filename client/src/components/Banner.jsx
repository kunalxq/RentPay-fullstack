...
const Banner = () => {
  ...
  return (
    ...
    className='flex flex-col md:flex-row md:items-start items-center justify-between px-8m min-md:pl-4 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>

        <div className='text-white '>
            <h2 className='text-3xl font-medium'>Do You Own a Any Luxury Car</h2>
