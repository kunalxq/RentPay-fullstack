    ...
    return (
        <motion.div
                ...
                className='flex flex-wrap justify-between w-1/2 gap-8'>
                    ...
                    <div>
                        ...
                        <ul className='mt-3 flex flex-col gap-1.5'>
                            ...
                            <li><a href="./yourcar">List Your Car</a></li>
                    ...
                    <div>
                        ...
                        <ul className='mt-3 flex flex-col gap-1.5'>
                            ...
                            <li><a href="#"></a>Greater Noida, UP 201009 </li>
                            <li><a href="#"></a>+91 8433322211</li>
                            <li><a href="#"></a>rentpe@gmail.com</li>
                        </ul>
                    </div>
            ...
            className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p> Copyright © {new Date().getFullYear()} RentPay All rights reserved.</p>
